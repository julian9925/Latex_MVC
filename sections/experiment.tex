...
\end{figure}		
	...
	研究發現與景物的距離越遠在3D虛擬影像定位並不會影響誤差，整體來看，對定位的覆蓋率也有一定的提升。根據圖\ref{fig:Controlled_EV1_Result}所示，在均
...
\begin{figure}
	...
	\subfigure[定位環境 2.廚房環境]{\label{fig:Indoor_EV1}\includegraphics[width=1.0\columnwidth]{figures/Indoor_Kitchen_Result.eps}}
	\end{center}
  \caption{室內定位環境與待定位照片分布位置}
  \label{fig:Indoor_EV_and_Query}	
\end{figure}	